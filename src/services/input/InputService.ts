...
/** Solo / menu: arrows and WASD both drive P1. */
const P1_KEYS_SOLO: Record<string, Direction | 'fire'> = {
  ArrowUp: 'up',
  ArrowDown: 'down',
  ArrowLeft: 'left',
  ArrowRight: 'right',
...
/** 2P: P1 uses WASD; arrows go to P2. */
const P1_KEYS_2P: Record<string, Direction | 'fire'> = {
  w: 'up',
  W: 'up',
  s: 'down',
  S: 'down',
...
export class InputService {
  ...
  getPlayerInput(player: 1 | 2): { direction: Direction | null; fire: boolean } {
    const map =
      player === 1 ? (this.twoPlayer ? P1_KEYS_2P : P1_KEYS_SOLO) : P2_KEYS;
